/** ActiveCases: Wrapper component displaying active cases list for all user types. Integrates filtering, sorting, and tabular case display with status details. */
