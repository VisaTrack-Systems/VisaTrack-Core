...
export function UpcomingDeadlinesPanel({ deadlines, isLoading = false }: UpcomingDeadlinesPanelProps) {
  return (
    <div className="bg-white rounded-lg shadow-sm">
      ...
      <div className="p-6 space-y-4">
        {isLoading ? (
          <p className="text-sm text-gray-500">Loading upcoming deadlines...</p>
        ) : deadlines.length === 0 ? (
          <p className="text-sm text-gray-500">No upcoming deadlines right now.</p>
        ) : (
