...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("active_turn_id", postgresql.UUID(as_uuid=True)),
        sa.Column("active_turn_started_at", sa.DateTime(timezone=True)),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False, server_default=sa.text("now()")),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False, server_default=sa.text("now()")),
    )
    ...
    op.create_table(
        ...
        sa.Column("disclosed_sources", postgresql.JSONB(), nullable=False, server_default=sa.text("'[]'::jsonb")),
        sa.Column("provider", sa.String(length=30)),
        sa.Column("requested_model", sa.String(length=200)),
        ...
        sa.UniqueConstraint("chat_id", "sequence_number", name="uq_ai_chat_messages_sequence"),
    )
    op.create_index("idx_ai_chat_messages_chat_sequence", "ai_chat_messages", ["chat_id", "sequence_number"])
    ...
    op.create_table(
        ...
        sa.Column("adobe_validation_completed", sa.Boolean(), nullable=False, server_default=sa.false()),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False, server_default=sa.text("now()")),
    ...
    op.create_table(
        ...
        sa.Column("provider", sa.String(length=30), nullable=False),
        sa.Column("model", sa.String(length=200), nullable=False),
        sa.Column("actual_model", sa.String(length=200)),
        sa.Column("provider_request_id", sa.String(length=255)),
        sa.Column("finish_reason", sa.String(length=100)),
        sa.Column("input_tokens", sa.Integer()),
        sa.Column("output_tokens", sa.Integer()),
